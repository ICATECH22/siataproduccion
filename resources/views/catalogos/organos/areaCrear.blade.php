...
'title' => __('Registro de una unidad: ') ,
'description' => __('Cree una unidad y vincule a la direccion que pertenece'),
'class' => 'col-lg-12'
])
                    ...
                    <form method="post" action="{{ route('organosGuardar') }}" autocomplete="off" id="creacion">
                        ...
                        <div class="form-group{{ $errors->has('area') ? ' has-danger' : '' }}">
                            <div class="input-group input-group-alternative mb-3">
                                ...
                                <input class="form-control{{ $errors->has('area') ? ' is-invalid' : '' }}" placeholder="{{ __('Nombre Departamento') }}" type="text" name="area" value="{{ old('area') }}" required autofocus>
                            </div>
                            @if ($errors->has('area'))
                                ...
                                <div class="form-row col-10 col-sm-10">
                                    ...
                                    <div class="col-8 col-sm-8">
                                        <select style="width:100%;" class="form-control @error('direccion')  is-invalid @enderror" aria-label=".form-select-md example" name="direccion">
                                            ...
                                            <option name="id" value="{{ $direccion->id }}" style="background-color: #3332;">Unidad: {{ $direccion->area }}</option>
                                            @endforeach
                                        </select>
