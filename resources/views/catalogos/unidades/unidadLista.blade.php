            ...
            <div class="card-header border-0">
                <div class="row align-items-center">
                    ...
                    <div class="col text-right">
                        <a href="{{route('unidadesCrear')}}" class="btn btn-sm btn-primary">Agregar</a>
                    </div>
                </div>
            </div>
                ...
                <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('unidadesEditar', $unidad->idUnidad)}}"><i class="fas fa-pen"></i></a>


                                <a href="" onclick="eliminacion({{$unidad->idUnidad}})" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar"><i class="fas fa-trash"></i></a>
    ...
    function eliminacion(idDepartamento) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/catalogos/unidades/eliminar/" + idDepartamento,
                    ...
                    success: function(data) {
                        window.location = "{{ route('unidadesLista') }}";
                    }
                });
            }
        })
