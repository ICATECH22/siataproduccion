        ...
        <div class="col-xl-4">
            <div class="card shadow">
                <div class="card-header bg-transparent">
                    <div class="row align-items-center">
                        <div class="col">
                            <h6 class="text-uppercase text-muted ls-1 mb-1">Promedio de</h6>
                            <h2 class="mb-0">Solicitudes por dia</h2>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">Total enviados hoy</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($topMasSolicitado as $top)
                            <tr>
                                <td>
                                    {{ $loop->index + 1}}<!-- indice -->
                                </td>
                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">Promedio tiempo de respuesta</th>
                                <th scope="col"></th>
                            </tr>
                        </thead>
                        <tbody>
